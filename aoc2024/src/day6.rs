...
pub fn part2(input: &str) -> u32 {
    ...
    // optimisation - if the original path doesn't hit a particular point then adding an obstacle there will have no effect
    let original_path = guard_patrol(map.clone()).unwrap();
